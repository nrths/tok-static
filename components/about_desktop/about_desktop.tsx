    ...
    <div className={styles.container}>
      ...
      <div className={styles.textWrapper}>
        <p className={styles.text}>
          ...
          ресурсы. Мы делаем так потому, что любим нашу страну и верим в то, что
          в России есть все возможности для создания высококачественного
        ...
        <p className={styles.text}>
          Мы по настоящему заботимся о качестве нашей продукции, ведем контроль
          всего производственного процесса, начиная от заготовки сырья до
        ...
        <p className={styles.text}>
          Наша мебель проектируется и производится в Санкт-Петербурге, постоянно
          ведется работа над совершенствованием технологии и производственных
          процессов.
        </p>
        <p className={styles.text}>
