...
const BedsPage = ({ products }: any) => {
  ...
  return (
    <>
      <Head>
        <title>Кровати | ТОК-Мебель</title>
        <meta
          name='description'
          content='Кровати от фабрики дизайнерской мебели ТОК'
        />
      </Head>
      <Header />
      <FilterMenu />
...
export async function getStaticProps() {
  ...
  const beds = data.filter(
    (product: { category: string }) => product.category === "BED"
  );
  return {
    props: {
      products: beds,
