...
const News: TNewsItem[] = [
  ...
  },
  {
    ...
    description:
      "ARTDOM - эксклюзивный выставочный проект, посвященный формированию мебельной и интерьерной моды, определяющий тенденции развития мебельного рынка на ближайшие годы.",
